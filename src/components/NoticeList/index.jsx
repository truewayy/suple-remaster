    ...
    return (
        <div>
            ...
            <Modal
                ...
                >
                    <NoticeDetail setModalIsOpen={setModalIsOpen} title={props.title} date={props.date} content={props.content} />
            </Modal>
        </div>
    )
}
...
const NoticeList = (props) => {
    ...
    return (
        props.db && props.db.map((v,i)=>{
            return(
                <NoticeContent title={v.title} date={v.date} content={v.content} key={v.notice_id} />
            )
        })
    )
}
